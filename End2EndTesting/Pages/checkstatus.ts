...
export class checkstatus{
    ...
    constructor(page:Page){
        ...
        this.dropdown1=page.locator('//p-dropdown[@styleclass="body-1-regular"]/div[1]/span');
        //this.mybookings=page.locator('//div[@class="p-dropdown-items-wrapper ng-tns-c109-2"]/ul/p-dropdownitem[2]/li/span');
        this.mybookings=page.locator('//div[@class="p-dropdown-items-wrapper"]/ul/p-dropdownitem[2][@class="p-element ng-star-inserted"]//span[@class="ng-star-inserted"]');
        this.search=page.locator('//header[@class="f-table-head-section"]/div[2]/span/input');
        this.dropdown2=page.locator('//p-dropdown[@styleclass="p-paginator-rpp-options"]/div');
        //this.select=page.locator('//div[@class="ng-trigger ng-trigger-overlayAnimation ng-tns-c109-7 p-dropdown-panel p-component ng-star-inserted"]/div/ul/p-dropdownitem[1]/li/span');
        this.select=page.locator('//div[@class="p-dropdown-items-wrapper"]/ul/p-dropdownitem[1][@class="p-element ng-star-inserted"]/li/span[@class="ng-star-inserted"]');
        this.select30=page.locator('//div[@class="p-dropdown-items-wrapper"]/ul/p-dropdownitem[3][@class="p-element ng-star-inserted"]/li/span[@class="ng-star-inserted"]');
        //this.textvalue=page.locator('//p-dropdown/div/span[@id="pr_id_5_label"]');
        this.textvalue=page.locator('//div[@class="p-paginator-rpp-options p-dropdown p-component p-inputwrapper p-inputwrapper-filled"]/span[@class="p-element p-dropdown-label p-inputtext ng-star-inserted"]');
        this.status1 = page.locator('[data-testid="td-status"]>div>i~span');
        this.status2=page.locator('[data-testid="td-last-modified"]>div>span:nth-of-type(2)');
        //this.status2=page.locator('[data-testid="td-created"]>div>span:nth-of-type(2)');
    }
    ...
    async verifyDraftmybookingsRecords() {
        ...
        //await this.page.waitForSelector('[data-testid="td-created"]>div>span:nth-of-type(2)', { state: 'attached', timeout: 10000 }).catch(() => console.log("Last modified elements not found"));
        const resultCount = await this.page.locator('[data-testid="td-status"]>div>i~span').all();
        const bookingsCount = await this.page.locator('[data-testid="td-last-modified"]>div>span:nth-of-type(2)').all();
        //const bookingsCount = await this.page.locator('[data-testid="td-created"]>div>span:nth-of-type(2)').all();
...
//await this.page.waitForSelector('[data-testid="td-created"]>div>span:nth-of-type(2)', { timeout: 10000 });
...
for (let i = 0; i < recordsPerPage; i++) {
    ...
    //const bookingsText = await this.page.locator('[data-testid="td-created"]>div>span:nth-of-type(2)').nth(i).textContent();
...
async verifyConfirmedRecords20() {
    ...
    //await this.page.waitForSelector('[data-testid="td-created"]>div>span:nth-of-type(2)');
    await this.page.waitForSelector('//div[@class="p-paginator-rpp-options p-dropdown p-component p-inputwrapper p-inputwrapper-filled"]/span[@class="p-element p-dropdown-label p-inputtext ng-star-inserted"]');
